...
-- BUTTON
-----------------------------------------------------------------------------------------------------------------------------------------
local armas = {"STONEHATCHET", "POOLCUE", "WRENCH", "NIGHTSTICK", "SWITCHBLADE", "MACHETE", "KNIFE", "KNUCKLES", "HATCHET", "HAMMER", "GOLFCLUB", "FLASHLIGHT", "CROWBAR", "BOTTLE", "BAT", "DAGGER", "GRENADE", "MOLOTOV", "PISTOL_MK2", "BZGAS", "STICKYBOMB", "PROXMINE", "SNOWBALL", "PIPEBOMB", "BALL", "SMOKE", "FLARE", "PARACHUTE",
